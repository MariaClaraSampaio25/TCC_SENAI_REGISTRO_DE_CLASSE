    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label>Nome</label>
            ...
            <br/>
            <label>Data_de_abertura</label>
            <input type="date" class="form-control" name ="Data_de_abertura" required/>
            <br/>
            <label>Data_de_encerramento</label>
            <input type="date" class="form-control" name ="Data_de_encerramento" required/>
            <br/>
