                ...
                <div class="col-md-12">
                    <div class="card mb-4 rounded-3 shadow-sw">
                        <div class="card-header py-3">
                            ...
                            </svg>&nbsp;&nbsp;EDIÇÃO DE CADASTRO DE PROFESSORES</h4>
                        </div>
                        <div class="card-body">
                        ...
                        ?>
                        <form action="editarprof.php?id=<?php echo $Id;?>" method = "post">
                        
                         <label>Nome</label>
                         <input type="text" class="form-control" name ="Nome" value= "<?php echo $Nome?>" required/>
                         <br/>
                         <label>Disciplina</label>
                         <input type="text" class="form-control" name ="Disciplina" value= "<?php echo $Disciplina?>" required/>
                         <br/>
                         <label>E-mail</label>
